...
//            rs = null;
    ...
    private static void startConnectionForWrite(String sql) {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/Donatrix", "root",
...
//            ResultSet rs = stmt.executeQuery(sql);
    ...
    public static void registerUser(String username, String password, String locked, String name) {
...
//        me.registerUser("dpoole@gatech.edu", "password", "0", "Davidson Poole");
        registerUser("pgibert@gatech.edu", "password", "0", "Paul Gibert");
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("select * from donatrix.users where email = 'zday123@yahoo.com'");
        } catch(Exception e) {
            System.out.println(e);
        }
    }
